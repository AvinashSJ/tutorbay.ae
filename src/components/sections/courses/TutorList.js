    ...
    <section className="py-30px lg:py-50px">
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-30px">
          {tutors?.map((tutor) => (
            <div key={tutor._id} data-aos="fade-up" className="group">
              <div className="mb-30px relative flex flex-col items-center">
                ...
                {/* social icons */}
                <div className="absolute transition-all duration-300 left-0 -top-3 opacity-0 group-hover:opacity-100 group-hover:animate-spin-infinit2 w-full">
                  <svg
                    className="w-full"
                    width="337"
                    height="324"
              ...
              <div className="text-center">
                <h5>
                  <Link
                    ...
                    className="text-size-28 leading-45px font-semibold text-contentColor capitalize dark:text-contentColor-dark hover:text-primaryColor dark:hover:text-primaryColor"
                  >
